# Base10 · Vertical AI Consensus Cohort & DNA

Vertical-AI consensus-deal cohort + DNA + methodology. The reference set used to grade Casap and future vertical-AI deals. Internal Base10.

**Live URL**: `https://ade-B10.github.io/consensus-cohort-vertical-ai/`
...
2. Enter the team password (saved in 1Password under "Base10 · Vertical AI Consensus Cohort & DNA")
...
```bash
cd /Users/ade/Desktop/Urizen/consensus-cohort-vertical-ai-deploy

# 1. Drop the updated unencrypted HTML into source/
cp /Users/ade/Desktop/Urizen/Consensus_Cohort_Vertical_AI.html source/
...
# 3. Commit and push
git add index.html
git commit -m "Refresh Base10 · Vertical AI Consensus Cohort & DNA ($(date +%Y-%m-%d))"
git push
```
