...
#
# Usage:
#   1. Put the updated unencrypted file at source/Consensus_Cohort_Vertical_AI.html
...
SOURCE_FILE="source/Consensus_Cohort_Vertical_AI.html"
OUTPUT_FILE="index.html"
LABEL="Base10 · Vertical AI Consensus Cohort & DNA"
INSTRUCTIONS="Enter the password to access Base10 · Vertical AI Consensus Cohort & DNA."
REMEMBER_DAYS=14
...
if [ ! -f "$SOURCE_FILE" ]; then
  ...
  echo "  mkdir -p source"
  echo "  cp /Users/ade/Desktop/Urizen/Consensus_Cohort_Vertical_AI.html source/"
  echo ""
  exit 1
fi
...
sed -i.bak "s|<title>Protected Page</title>|<title>Base10 · Vertical AI Consensus Cohort & DNA</title>|" "$OUTPUT_FILE"
...
echo "  git commit -m \"Refresh Base10 · Vertical AI Consensus Cohort & DNA ($(date +%Y-%m-%d))\""
echo "  git push"
echo ""
